...
$rsData = CUserTypeEntity::GetList( array(), array("ENTITY_ID"=>"HLBLOCK_15") );
$arrType_h15=Array();
while($arRes = $rsData->Fetch())
{
	$arrType_h15[$arRes["FIELD_NAME"]]=$arRes["USER_TYPE_ID"];
}
$arr_o = Array(">=UF_DATE_CLOSE"=>$dateWeekAgo." 00:00:00", "<=UF_DATE_CLOSE"=>$date." 23:59:59");
...
echo "<pre>";
print_r($Sip->CloseApplication(base64_encode($xml->saveXML())));
echo "</pre>";
