...
$(document).ready(function(){
   $(".find_middle_price").click(function(){
    ...
    $(".find_middle_price").click();
	$(".middle_price_block a").click(function(){
...
<style>
	...
	.middle_price_block {
 	...
 	.middle_price_block div.column_m_price
    {
		width:60%;
		font-size:20px;
		display:inline-block;
    ...
    .middle_price_block div.column_m_price:last-child {
		width:40%;
        background:#e1e1e1;
		height: 83px;
    	line-height: 83px;
	...
	.middle_price_block div.column_m_price:last-child span {
		font-size:26px;
	}
	.column_m_price span b {
		color:#000;
		font-style:italic;
	}
	.column_m_price.green span {
		color:#05761a;
	}
	.column_m_price.red span {
		color:red;
	}
	#more_middle_price {
		color:#4b66ab;
						...
						<div class="field_to_fill <?=(in_array($rrr["FIELD_NAME"],Array("UF_CLIENT_PRICE")))?"no_padding_right":""?>">
							...
							else 
							{
								if(strpos($rrr["FIELD_NAME"],"PRICE")!==FALSE)
								{
									...
									<?if($rrr["FIELD_NAME"]=="UF_CLIENT_PRICE"):?><a class="find_middle_price"  href="javascript:void(0);">Подобрать цену</a>
									<div class="middle_price_block hide"><a href="#"><div class="column_m_price"><span>Средняя цена<br><b id="middle_price"></b></span></div><div class="column_m_price green"><span id="middle_price_percent"></span></div></a><a id="more_middle_price" href="javascript:void(0);">...</a></div>
									<?endif;?>
								<?}
								else
								{
