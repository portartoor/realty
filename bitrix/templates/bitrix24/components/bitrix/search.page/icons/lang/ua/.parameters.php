...
$MESS["TP_BSP_SHOW_TAGS_CLOUD"] = "Показувати хмара тегів";
$MESS["TP_BSP_FONT_MAX"] = "Максимальний розмір шрифту (px)";
$MESS["TP_BSP_FONT_MIN"] = "Мінімальний розмір шрифту (px)";
$MESS["TP_BSP_COLOR_OLD"] = "Колір раннього тега (приклад: \"FEFEFE\")";
$MESS["TP_BSP_COLOR_NEW"] = "Колір пізнього тега (приклад: \"C0C0C0\")";
$MESS["TP_BSP_CNT"] = "За популярністю";
$MESS["TP_BSP_COLOR_TYPE"] = "Плавна зміна кольору";
$MESS["TP_BSP_NAME"] = "На ім'я";
...
$MESS["TP_BSP_URL_SEARCH"] = "Шлях сторінки пошуку (від кореня сайту)";
