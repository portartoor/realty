									...
									<div id="footer">
										...
										<span id="copyright">
											<?if (IsModuleInstalled("bitrix24")):?>
												...
												<span class="bx-lang-btn <?=LANGUAGE_ID?>" id="bx-lang-btn" onclick="B24.openLanguagePopup(this)" data-langs='{ "ru": "<?=$b24Languages["ru"]?>", "en": "<?=$b24Languages["en"]?>", "de": "<?=$b24Languages["de"]?>", "ua": "<?=$b24Languages["ua"]?>", "la": "<?=$b24Languages["la"]?>", "tc": "<?=$b24Languages["tc"]?>", "sc": "<?=$b24Languages["sc"]?>", "br": "<?=$b24Languages["br"]?>", "in": "<?=$b24Languages["in"]?>", "fr": "<?=$b24Languages["fr"]?>"}'>
