...
<div class="employee-search-block">
	<?if((CModule::IncludeModule('bitrix24') && CBitrix24::isInvitingUsersAllowed() || !IsModuleInstalled("bitrix24") && $USER->CanDoOperation('edit_all_users')) && CModule::IncludeModule('intranet') && $arParams['TABLE_VIEW']!='group_table'):?>
		<a class="webform-small-button webform-small-button-blue bx24-top-toolbar-add" href="javascript:void(0)" onclick="<?=CIntranetInviteDialog::ShowInviteDialogLink()?>">
