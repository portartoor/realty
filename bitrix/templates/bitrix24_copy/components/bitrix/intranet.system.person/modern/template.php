...
function user_action_menu<?=$user_action_menu_number?> (button, number, user_id, is_extranet) {
	...
	{
		popupUserMenuItems.push({ text : "<?=GetMessage("INTR_ISP_VIDEO_CALL")?>", className : "profile-menu-videocall", onclick : function() {if (BXIM) { BXIM.callTo(user_id); return false;}}});
	}
	<?endif?>
