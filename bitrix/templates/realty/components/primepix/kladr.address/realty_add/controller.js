    ...
    this.Init = function(token, key){        
        ...
        $(function(){
            ...
            var SetRegion = function(obj){
                ...
                region.parent().parent().find('[name="region_label"]').val( type );
                region.parent().parent().find('[name="region_label_min"]').val( obj.typeShort );

                if(options.updateLabels){
                    region.parent().prev().find('label').text( "("+obj.typeShort+")" );
                }
            ...
            var SetDistrict = function(obj){
                ...
                district.parent().parent().find('[name="district_label"]').val( type );
                district.parent().parent().find('[name="district_label_min"]').val( obj.typeShort );

                if(options.updateLabels){
                    district.parent().prev().find('label').text( "("+obj.typeShort+")" );
                }
                ...
                SetKladrId();
                SetZipCode();
				var ar = ["district",obj.name];
				inputChangeinBd(district,ar);
            };
            ...
            var SetLocation = function(obj){
                ...
                location.parent().parent().find('[name="location_label"]').val( type );
                location.parent().parent().find('[name="location_label_min"]').val( obj.typeShort );

                if(options.updateLabels){
                    location.parent().prev().find('label').text( "("+obj.typeShort+")" );
                }
                ...
                SetKladrId();
                SetZipCode();
				var ar = ["location",obj.name];
				inputChangeinBd(location,ar);
            };
            ...
            var SetStreet = function(obj){
                ...
                street.parent().parent().find('[name="street_label"]').val( type );
                street.parent().parent().find('[name="street_label_min"]').val( obj.typeShort );

                if(options.updateLabels){
                    street.parent().prev().find('label').text( "("+obj.typeShort+")" );
                }
               ...
               // building.kladr( "option", { parentType: $.ui.kladrObjectType.STREET, parentId: obj.id } );
                ...
                SetKladrId();
                SetZipCode();
				var ar = ["street",obj.name];
				inputChangeinBd(street,ar);
            };
            ...
            var SetBuilding = function(obj){
                ...
                building.parent().parent().find('[name="building_label"]').val( type );
                building.parent().parent().find('[name="building_label_min"]').val( obj.typeShort );
                ...
                SetKladrId();
                SetZipCode();
				var ar = ["building",obj.name];
				inputChangeinBd(building,ar);
            };
			...
			district.kladr( "option", { parentType: $.ui.kladrObjectType.REGION, parentId: region.data( "kladr-obj" ) } );
			location.kladr( "option", { parentType: $.ui.kladrObjectType.REGION, parentId: region.data( "kladr-obj" ) } );
            street.kladr( "option", { parentType: $.ui.kladrObjectType.REGION, parentId: region.data( "kladr-obj" ) } );
            //building.kladr( "option", { parentType: $.ui.kladrObjectType.REGION, parentId: region.data( "kladr-obj" ) } );
        });
...
$(document).ready(function(){
	...
	var position;
    function init(){
		if($("input[name=UF_LATITUDE]").val()!=0&&$("input[name=UF_LONGITUDE]").val()!=0)
		{
			position = [$("input[name=UF_LATITUDE]").val(),$("input[name=UF_LONGITUDE]").val()];
		}
		else
		{
