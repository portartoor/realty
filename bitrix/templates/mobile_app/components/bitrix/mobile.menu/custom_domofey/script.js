...
(function ()
{
	...
	BX.Menu = function ()
	{
		...
		BX.addCustomEvent('onClearLFCounter', function (counterCode)
		{
			var ob = {};
			ob[counterCode] = 0;
	...
	BX.addCustomEvent('onGetLFCounter', function (ob)
	{
		if (
			typeof ob != 'undefined'
			&& typeof ob.id != 'undefined'
			&& typeof BX.Menu.counters[ob.id] != 'undefined'
		)
		{
			ob.value = BX.Menu.counters[ob.id]["value"];
			ob.zeroCounter = BX.Menu.counters[ob.id]["zeroCounter"];
		}
	});
