...
<div id="bx-component-scope-<?=$templateId?>" class="task-template-selector">
	...
	<span data-bx-id="templateselector-open" class="
		...
		<?if($hasButton):?>bx24-top-toolbar-button tasks-toolbar-dropdown-btn<?endif?> task-list-toolbar-templates
		" title="<?=Loc::getMessage('TASKS_TTDP_TEMPLATESELECTOR_CREATE_HINT')?>">
		<span class="webform-small-button-icon"></span>
		<?if($hasButton):?><?=htmlspecialcharsbx($arParams['TEMPLATE_DATA']['BUTTON_LABEL'])?><?endif?>
	</span>
