		...
		methods: {
			...
			makeHintText: function (params)
			{
				...
				if (params.START_DATE != '')
				{
					...
					var shortStart = BX.date.format(BX.date.convertBitrixFormat(BX.message('FORMAT_DATE')), BX.parseDate(params.START_DATE, true), false, true);
				...
				{
					// start date to short format
					var shortEnd = BX.date.format(BX.date.convertBitrixFormat(BX.message('FORMAT_DATE')), BX.parseDate(params.END_DATE, true), false, true);
