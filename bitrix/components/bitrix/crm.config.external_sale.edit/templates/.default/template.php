...
else
{
	...
	$passValue = '<input type="password" name="PASSWORD" size="30">';
	...
	<a onclick="javascript:__BXOnImportGroupShow()" class="crm-field-action-link" id="id_GROUP_TXT"><?= $arGroup ? $arGroup["NAME"] : GetMessage("BPWC_WNCT_DO_SELECT") ?></a>
	<?
