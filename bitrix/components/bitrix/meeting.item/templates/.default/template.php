...
?>
	<a href="<?echo str_replace('#MEETING_ID#', $arResult['FROM_MEETING'], $arParams['MEETING_URL_TPL'])?>" class="meeting-title-button">
		<i class="meeting-title-button-back-icon"></i><span class="meeting-link"><?=GetMessage('ME_BACK')?></span>
	</a>
<?
endif;
?>
