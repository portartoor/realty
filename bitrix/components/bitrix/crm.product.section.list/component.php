...
if($_SERVER['REQUEST_METHOD'] === 'POST' && check_bitrix_sessid())
{
	...
	if($gridAction === 'delete' && $arResult['CAN_DELETE'])
	{
		...
		foreach($arIDs as $deletedSectionID)
		{
			$section->Delete($deletedSectionID, false);
		}
	...
	elseif($gridAction === 'edit' && $arResult['CAN_EDIT'])
	{
		...
		foreach($_POST['FIELDS'] as $updatedSectionID => $arField)
		{
			$arField['CHECK_PERMISSIONS'] = 'N';
			$section->Update($updatedSectionID, $arField);
		}
