if (typeof(getToken) == "undefined")
{
	...
	BX.addCustomEvent("onPullEvent", function (module_id, command, params)
	{
		if(module_id == "im")
		{
			imData.push({'command': command, 'params': params});
		...
		{
			BXMobileApp.onCustomEvent('onPull-'+module_id, {'command': command, 'params': params}, true);
			BXMobileApp.onCustomEvent('onPull', {'module_id': module_id, 'command': command, 'params': params}, true);
		}
	...
	{
		BXMobileApp.onCustomEvent('onPullOnline', {'command': command, 'params': params}, true);
	});
