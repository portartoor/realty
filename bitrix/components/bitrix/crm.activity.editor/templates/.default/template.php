...
$editorCfg = array(
	...
	'defaultStorageTypeId' => CCrmActivity::GetDefaultStorageTypeID(),
...
<div id="<?= $editorCfg['emailLheContainerID'] ?>" style="display:none;"><?
	...
	$emailEditor->Show(
		array(
			'id' => 'CRM_ACTIVITY_EDITOR_'.$prefixUpper,
			'height' => '150',
			'BBCode' => true,
		...
		function()
		{
			...
			if(typeof(BX.CrmActivityEditor.messages) === 'undefined')
			{
				BX.CrmActivityEditor.messages =
				{
					...
					"webdavFileLoading": "<?= GetMessageJS('CRM_ACTIVITY_WEBDAV_FILE_LOADING')?>",
					"webdavFileAlreadyExists": "<?= GetMessageJS('CRM_ACTIVITY_WEBDAV_FILE_ALREADY_EXISTS')?>",
					"webdavFileAccessDenied" : "<?= GetMessageJS('CRM_ACTIVITY_WEBDAV_FILE_ACCESS_DENIED')?>",
					"webdavAttachFile" : "<?= GetMessageJS('CRM_ACTIVITY_WEBDAV_ATTACH_FILE')?>",
					"webdavTitle" : "<?= GetMessageJS('CRM_ACTIVITY_WEBDAV_TITLE')?>",
					"webdavDragFile" : "<?= GetMessageJS('CRM_ACTIVITY_WEBDAV_DRAG_FILE')?>",
					"webdavSelectFile" : "<?= GetMessageJS('CRM_ACTIVITY_WEBDAV_SELECT_FILE')?>",
					"webdavSelectFromLib" : "<?= GetMessageJS('CRM_ACTIVITY_WEBDAV_SELECT_FROM_LIB')?>",
					"webdavLoadFiles" : "<?= GetMessageJS('CRM_ACTIVITY_WEBDAV_LOAD_FILES')?>"
				};
			}
			...
			if(typeof(BX.CrmActivityCalEvent.messages) === 'undefined')
			{
				BX.CrmActivityCalEvent.messages =
				{
					...
					"enableNotification": "<?= GetMessageJS('CRM_ACTIVITY_DLG_FIELD_ENABLE_NOTIFICATION')?>",
					"enableNotifyBefore": "<?= GetMessageJS('CRM_ACTIVITY_DLG_FIELD_NOTIFY_BEFORE')?>",
