...
<tr  style="background-color: #ededed;">
	<td class="bx-padding" colspan="2" style="background:none; text-align: center; font-weight: bold;">
			<input type="radio" type="checkbox" value="Y" id="CONVERT_CONTACT_Y" name="CONVERT_CONTACT" <?=($bChecked ? 'checked' : '')?> 
			onclick="BX('CONTACT_form').style.display = (BX('CONTACT_form').style.display == 'none' ? 'block' : 'none');
		BX('CONTACT_choise').style.display = (BX('CONTACT_choise').style.display == 'none' ? '' : 'none');" /><label for="CONVERT_CONTACT_Y" style="padding-right: 70px;"><?=GetMessage('CRM_FIELD_CONVERT_CONTACT')?></label>
			<input type="radio" type="checkbox" value="N" id="CONVERT_CONTACT_N" name="CONVERT_CONTACT" <?=(!$bChecked ? 'checked' : '')?>
			onclick="BX('CONTACT_form').style.display = (BX('CONTACT_form').style.display == 'none' ? 'block' : 'none');
		BX('CONTACT_choise').style.display = (BX('CONTACT_choise').style.display == 'none' ? '' : 'none');"/><label for="CONVERT_CONTACT_N"><?=GetMessage('CRM_FIELD_CONVERT_CONTACT_LIST')?></label>
	</td>
</tr>
