function BxInterfaceGrid(table_id)
{
	...
	this.EditCurrentView = function()
	{
		...
		this.ShowSettings(this.oOptions.views[this.oOptions.current_view],
			function()
			{
				var data = self.SaveSettings(self.oOptions.current_view);
				...
				if(data.saved_filter && self.oOptions.filters[data.saved_filter])
				{
					window.setTimeout(function(){ self.ApplyFilter(data.saved_filter); }, 500);
				}
				else
				{
