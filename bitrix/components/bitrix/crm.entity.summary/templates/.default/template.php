	...
	function __CrmEntitySummaryRenderHorSectionItem(&$item)
	{
		...
		if($type === '')
		{
			echo '<span class="crm-detail-info-item-name">', htmlspecialcharsbx($title), '</span>',
				'<span class="crm-detail-info-item-text">',
		...
		elseif($type === 'MULTIFIELD')
		{
			...
			echo '<span class="crm-detail-info-item-name">', htmlspecialcharsbx($title), '</span>',
				'<span class="crm-detail-info-item-text crm-item-tel">';
			...
			if($valueCount > 1)
			{
				...
				echo '<span class="crm-item-tel-list" id="', htmlspecialcharsbx($anchorID), '"',
				' onclick="',
				CCrmViewHelper::PrepareMultiFieldValuesPopup($anchorID, $anchorID, $typeName, $values, $valueTypes),
				'"></span>';
			}
			echo '</span>';
		}
		...
		elseif($type === 'DURATION')
		{
			...
			echo '<span class="crm-detail-info-item-name">', htmlspecialcharsbx($title), '</span>',
				'<span class="crm-detail-info-item-text crm-item-date">';
		...
		elseif($type === 'MONEY')
		{
			...
			{
				echo '<span class="crm-detail-info-item-text">',
					htmlspecialcharsbx(CCrmCurrency::MoneyToString($value, $currencyID)),
					'</span>';
			}
			else
			{
