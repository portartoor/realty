<?
$MESS['WD_HELP_BPHELP_TEXT'] = "<p><b>Примечание</b>: подробную информацию о бизнес-процессах смотрите на странице <a href=\"#LINK#\" target=\"_blank\">Бизнес-процессы</a>.</p>";
$MESS['WD_HELP_FULL_TEXT'] = "С библиотекой документов можно работать двумя способами: через браузер (Internet Explorer, Opera, FireFox и т.д.) или через WebDAV-клиенты ОС (для ОС Windows: компонент веб-папок, подключение диска). <br><br>
<ul>
...
<p><a href=\"javascript:ShowImg('#TEMPLATEFOLDER#/images/load_form.png',661,575,'Форма для загрузки документов');\">
...
<p><a href=\"javascript:ShowImg('#TEMPLATEFOLDER#/images/new_bizproc.png',622,459,'Запуск бизнес-процесса');\">
...
<p><a href=\"javascript:ShowImg('#TEMPLATEFOLDER#/images/delete_file.png',399,516,'Изменение, удаление документов');\">
...
<p><a href=\"javascript:ShowImg('#TEMPLATEFOLDER#/images/vista_reg_2.png',572,212,'Диалог ОС');\">
...
<p><a href=\"javascript:ShowImg('#TEMPLATEFOLDER#/images/web_client.png',638,450,'Службы');\">
...
<p><a href=\"javascript:ShowImg('#TEMPLATEFOLDER#/images/web_client_prop.png',410,461,'Свойство службы Веб-клиент');\">
...
<p><a href=\"javascript:ShowImg('#TEMPLATEFOLDER#/images/connection.png',719,490,'Подключение');\">
...
<li>В поле <b>Папка</b> введите путь до библиотеки: <i>http://&lt;ваш_сервер&gt;/docs/shared/</i>. Если необходимо, что бы папка подключалась для просмотра при каждом запуске системы, установите флажок <b>Восстанавливать при входе в систему</b>.</li>
