...
BX.CrmWebDavUploader.prototype =
{
	...
	_onShowUploadedFile: function(agent)
	{
		...
		var elementId = uploadResult && typeof(uploadResult.element_id) != "undefined" ? parseInt(uploadResult.element_id) : 0;
		...
		this.addValue(
			{
				"ID": elementId,
				"EDIT_URL": uploadResult.element_url
			}
		);
		...
		{
			loader(elementId, BX.delegate(this._onElementInfoLoad, this));
		}

		/*BX.ajax.get(
			this._prepareElementShowUrl(elementId, uploadResult.element_url),
			BX.delegate(this._onUploadedFileHtmlLoad, this)
		);*/
	},
