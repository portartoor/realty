...
$arResult['FIELDS'][] = array(
	...
	'type' => $fieldType,
	'value' => isset($arResult['ELEMENT']['~CONTENT']) ? htmlspecialcharsback($arResult['ELEMENT']['~CONTENT']) : '',
);
...
$arResult['FIELDS'][] = array(
	...
	'type' => $fieldType,
	'value' => isset($arResult['ELEMENT']['~TERMS']) ? htmlspecialcharsback($arResult['ELEMENT']['~TERMS']) : ''
);
