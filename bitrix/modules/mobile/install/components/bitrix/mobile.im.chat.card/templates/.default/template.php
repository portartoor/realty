...
<script type="text/javascript">
	...
	BX.addCustomEvent("onPull-im", function(data)
	{
		...
		else if (data.command == 'chatChangeColor')
		{
			...
			{
				pageColor = data.params.chatColor;
				BX.style(BX('chat-profile-top'), 'background-color', data.params.chatColor);
				app.exec("setTopBarColors",{background: data.params.chatColor, titleText:"#ffffff", titleDetailText:"#f0f0f0"});
			}
		}
