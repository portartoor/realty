			...
			<?if($arParams['ENABLE_FOOTER']):?>
				...
				<div data-bx-id="task-edit-footer" class="webform-buttons pinable-block <?=($arResult['TEMPLATE_DATA']['FOOTER_PINNED'] ? 'pinned' : '')?>">
	                ...
	                <div class="tasks-form-footer-container">
	                    ...
	                    <a data-bx-id="task-edit-cancel-button" href="<?=htmlspecialcharsbx(Util::secureBackUrl($arResult['TEMPLATE_DATA']['CANCELURL']))?>" class="webform-button-link"><?=Loc::getMessage('TASKS_TASK_COMPONENT_TEMPLATE_CANCEL')?></a>
