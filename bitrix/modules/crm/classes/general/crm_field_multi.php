	...
	public static function GetEntityTypes()
	{
		if(self::$ENTITY_TYPES === null)
		{
			self::$ENTITY_TYPES = Array(
				...
				'IM' => Array(
					'FACEBOOK' => Array('FULL' => GetMessage('CRM_FM_ENTITY_IM_FACEBOOK'), 'SHORT' => GetMessage('CRM_FM_ENTITY_IM_FACEBOOK_SHORT'), 'TEMPLATE' => '#VALUE_HTML#'),
					'TELEGRAM' => Array('FULL' => GetMessage('CRM_FM_ENTITY_IM_TELEGRAM'), 'SHORT' => GetMessage('CRM_FM_ENTITY_IM_TELEGRAM_SHORT'), 'TEMPLATE' => '<a href="https://telegram.me/#VALUE_URL#" target="_blank">#VALUE_HTML#</a>'),
					...
					'VIBER' => Array('FULL' => GetMessage('CRM_FM_ENTITY_IM_VIBER'), 'SHORT' => GetMessage('CRM_FM_ENTITY_IM_VIBER_SHORT'), 'TEMPLATE' => '<a href="http://chats.viber.com/#VALUE_URL#" target="_blank">#VALUE_HTML#</a>'),
