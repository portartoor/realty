...
class CCrmMobileHelper
{
	...
	public static function PrepareDealItem(&$item, &$params, $enums = array())
	{
		...
		$stageList = $enums && isset($enums['STAGE_LIST'])
			? $enums['STAGE_LIST'] : CCrmViewHelper::GetDealStageInfos();
