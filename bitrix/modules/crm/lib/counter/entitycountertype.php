...
class EntityCounterType
{
	...
	public static function getListFilterInfo(array $params = null)
	{
		if($params === null)
		{
			$params = array();
		...
		return array_merge(
			array(
				...
				'items' => array(
					'' => '',
					self::IDLE => GetMessage('CRM_ENTITY_COUNTER_TYPE_FILTER_IDLE'),
					self::PENDING => GetMessage('CRM_ENTITY_COUNTER_TYPE_FILTER_PENDING'),
					self::OVERDUE => GetMessage('CRM_ENTITY_COUNTER_TYPE_FILTER_OVERDUE')
				)
			),
			$params
		);
