	...
	public static function renderView(array $activity)
	{
		...
		return '<div class="crm-task-list-1c">
				<div class="crm-task-list-1c-info-container">
					...
					'.
					($manager !== '' ? '
					<div class="crm-task-list-1c-person">
						<div class="crm-task-list-1c-person-title">'.Loc::getMessage('CRM_REST_EXTERNAL_CHANNEL_ACTIVITY_LABEL_RESPONSIBLE').'</div>
							<span class="crm-task-list-1c-person-inner">
								<span class="crm-task-list-1c-person-user"></span>
								<span class="crm-task-list-1c-person-user-container">
									'.$manager.'
									<span class="crm-task-list-1c-person-user-description"></span>
								</span>
							</span><!--crm-task-list-1c-person-->
