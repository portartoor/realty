...
class EntityRecoveryData
{
	...
	protected static $enable—ompression = null;
	...
	{
		if(self::$enable—ompression === null)
		{
			self::$enable—ompression = function_exists('gzcompress') && function_exists('gzuncompress');
		}

		return self::$enable—ompression;
	}
}