...
class CBPCrmGetDataEntityActivity extends CBPActivity
{
	...
	protected static function getEntityFields($entityType)
	{
		...
		{
			case 'LEAD':
				$entityFields = CCrmDocumentLead::getEntityFields($entityType);
				break;
			case 'CONTACT':
				$listIgnoreFieldId = array('LEAD_ID', 'ORIGIN_ID', 'ORIGINATOR_ID');
				$listIgnoreAddressFieldId = array();
				$entityFields = CCrmDocumentContact::getEntityFields($entityType);
			...
			case 'COMPANY':
				...
				$listIgnoreAddressFieldId = array();
				$entityFields = CCrmDocumentCompany::getEntityFields($entityType);
