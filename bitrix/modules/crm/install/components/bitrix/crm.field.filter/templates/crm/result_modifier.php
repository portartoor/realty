...
if ($arParams['arUserField']['SETTINGS']['DEAL'] == 'Y' && CCrmDeal::CheckReadPermission(0, $CCrmPerms))
	$arParams['ENTITY_TYPE'][] = 'DEAL';
if ($arParams['arUserField']['SETTINGS']['QUOTE'] == 'Y' && !$CCrmPerms->HavePerm('QUOTE', BX_CRM_PERM_NONE, 'READ'))
	$arParams['ENTITY_TYPE'][] = 'QUOTE';
if ($arParams['arUserField']['SETTINGS']['PRODUCT'] == 'Y' && $CCrmPerms->HavePerm('CONFIG', BX_CRM_PERM_CONFIG, 'READ'))
...
if (isset($arSettings['LEAD']) && $arSettings['LEAD'] == 'Y')
{
	...
	$obRes = CCrmLead::GetListEx(array('ID' => 'DESC'), array(), false, array('nTopCount' => 50), $arSelect);
...
if (isset($arSettings['CONTACT']) && $arSettings['CONTACT'] == 'Y')
{
	...
	$obRes = CCrmContact::GetListEx(array('ID' => 'DESC'), array(), false, array('nTopCount' => 50), $arSelect);
	while ($arRes = $obRes->Fetch())
	{
		$imageUrl = '';
