								...
								<div class="mail-set-item-block-crm" id="mail-set-item-block-crm">
									<div class="mail-set-item-block-crm-wrapper" id="mail-set-item-block-crm-wrapper">
										<div class="mail-set-item-block-crm-wrapper-dec">
											...
											<? $crmNewLeadDenied = in_array('crm_deny_new_lead', $arParams['MAILBOX']['OPTIONS']['flags']); ?>
											<div class="mail-set-crm-item">
												<input class="mail-set-crm-check" id="edit_imap_crm_new_lead" type="checkbox" name="crm_new_lead" value="Y"
													<? if (!$crmNewLeadDenied): ?> checked<? endif ?>
													onclick="toggleSubordinateBlock('edit_imap_crm_new_lead_resp', this.checked); ">
												<label class="mail-set-crm-check-label" for="edit_imap_crm_new_lead"><?=getMessage('INTR_MAIL_INP_CRM_NEW_LEAD') ?></label>
												<div class="mail-set-crm-check-ext" id="edit_imap_crm_new_lead_resp"
													...
													<input class="mail-set-crm-check" type="checkbox" style="visibility: hidden; ">
													<label class="mail-set-crm-check-label"><?=getMessage('INTR_MAIL_INP_CRM_LEAD_RESP') ?>:</label>
													<div class="feed-add-post-destination-wrap mail-set-crm-resp-wrap" id="edit_imap_lead_resp_container"
														style="margin: 5px 0 0 23px; background-color: #ffffff; ">
									...
									<div class="mail-set-item-block-crm" id="mail-set-item-block-crm">
										<div class="mail-set-item-block-crm-wrapper" id="mail-set-item-block-crm-wrapper">
											<div class="mail-set-item-block-crm-wrapper-dec">
												...
												<div class="mail-set-crm-item">
													<input class="mail-set-crm-check" type="checkbox" checked disabled>
												...
												<div class="mail-set-crm-item" style="display: none; ">
													<input class="mail-set-crm-check" type="checkbox" style="visibility: hidden; ">
													<a href="#" class="mail-set-textarea-show" onclick="toggleCrmBlacklist(this, 'create_imap_<?=$id ?>_crm_blacklist'); return false; "><?=getMessage('INTR_MAIL_CRM_BLACKLIST') ?></a>
