...
if (!$bInternal)
{
	...
	$arResult['FILTER'] = array(
		...
		array('id' => 'MYCOMPANY_TITLE', 'name' => GetMessage('CRM_COLUMN_MYCOMPANY_TITLE')),
...
$arResult['HEADERS'] = 	array(
	...
	array('id' => 'MYCOMPANY_ID', 'name' => GetMessage('CRM_COLUMN_MYCOMPANY_ID'), 'sort' => 'mycompany_id', 'editable' => false),
