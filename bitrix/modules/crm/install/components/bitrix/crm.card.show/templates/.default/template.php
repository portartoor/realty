...
<?if ($arResult['SIMPLE']):?>
	<div class="crm-card-show-main">
		...
		<div class="crm-card-show-user-name">
			<div class="crm-card-show-user-name-item"><?=htmlspecialcharsbx($arResult['ENTITY']['FORMATTED_NAME'])?></div>
...
<?else:?>
	<div id="crm-card-detail-container" class="crm-card-show-detail">
