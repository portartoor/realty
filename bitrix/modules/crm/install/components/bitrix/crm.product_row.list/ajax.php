...
{
	$permissionEntityType = isset($_POST['PERMISSION_ENTITY_TYPE']) ? $_POST['PERMISSION_ENTITY_TYPE'] : '';
	if($permissionEntityType === '' || !CCrmPerms::HasPermissionEntityType($permissionEntityType))
	{
		$permissionEntityType = $ownerName;
	}
}
...
{
	if ($perms->HavePerm($permissionEntityType, BX_CRM_PERM_NONE, 'READ'))
	{
...
// 'OWNER_TYPE':'D', 'OWNER_ID':7 'PRODUCT_ID':100, 'QTY':1, 'CURRENCY_ID':1 'PRICE':100.50
	...
	if ($perms->HavePerm($permissionEntityType, BX_CRM_PERM_NONE, 'WRITE'))
	{
		__CrmPropductRowListEndResonse(array('ERROR'=>'PERMISSION_DENIED'));
	}
