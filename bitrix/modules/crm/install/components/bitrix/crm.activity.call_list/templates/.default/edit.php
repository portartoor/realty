		...
		<? else: ?>
			<div data-role="call-list-display">
				<div class="crm-activity-popup-edit-section-title">
					...
					<span class="crm-activity-popup-edit-add-more"
						   data-role="add-more"
						   data-url="<?=htmlspecialcharsbx($arResult['URLS']['ADD_MORE_URL'])?>"
					>
