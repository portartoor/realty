...
else
{
	$arResult['FIELDS']['tab_1'][] = array(
		...
		'componentParams' => array(
			...
			'ENTITY_IDS' => !empty($arResult['ELEMENT']['CONTACT_ID'])? array($arResult['ELEMENT']['CONTACT_ID']) : array(),
	...
	$arResult['FIELDS']['tab_1'][] = array(
		...
		'componentParams' => array(
			...
			'ENTITY_IDS' => !empty($arResult['ELEMENT']['COMPANY_ID'])? array($arResult['ELEMENT']['COMPANY_ID']) : array(),
			'ENTITIES_INPUT_NAME' => 'COMPANY_ID',
			'ENABLE_REQUISITES'=> false,
