		...
		<div class="crm-ads-rtg-popup-settings crm-ads-rtg-popup-settings-wrapper">
			<div class="crm-ads-rtg-popup-settings" style="<?=(!$provider['IS_SUPPORT_ACCOUNT'] ? 'display: none;' : '')?>">
				...
				<table class="crm-ads-rtg-table">
					<tr>
						<td>
							<select disabled name="ACCOUNT_ID" data-bx-ads-account="" class="crm-ads-rtg-popup-settings-dropdown">
							</select>
						</td>
						<td>
			...
			<div class="crm-ads-rtg-popup-settings">
				...
				<table class="crm-ads-rtg-table">
					<tr>
						<td>
							<select disabled name="AUDIENCE_ID" data-bx-ads-audience="" class="crm-ads-rtg-popup-settings-dropdown">
							</select>
						</td>
						<td>
			...
			<div class="crm-ads-rtg-popup-settings">
				...
				<table class="crm-ads-rtg-table">
					<tr>
						...
						<td>
							<select name="AUDIENCE_EMAIL_ID" data-bx-ads-audience="email" class="crm-ads-rtg-popup-settings-dropdown">
							</select>
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<select name="AUDIENCE_PHONE_ID" data-bx-ads-audience="phone" class="crm-ads-rtg-popup-settings-dropdown">
							</select>
						</td>
						<td>
			...
			<div data-bx-ads-audience-auto-remove="" class="crm-ads-rtg-popup-settings">
				...
				<div class="crm-ads-rtg-popup-chk-label">
						<select data-bx-ads-audience-auto-remove-select="" name="AUTO_REMOVE_DAY_NUMBER" <?=($isSelectedOnce ? '' : 'disabled')?> data-bx-ads-audience-auto-remove-select="" class="crm-ads-rtg-popup-settings-dropdown crm-ads-rtg-popup-settings-dropdown-sm">
							<?=$sDayValues?>
						</select>
