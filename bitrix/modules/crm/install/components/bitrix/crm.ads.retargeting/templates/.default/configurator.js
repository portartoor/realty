		...
		init: function ()
		{
			...
			audiences.forEach(function (audienceNode){
				...
				this.uiNodes.audience.push({
					type: audienceType,
					node: audienceNode,
					loader: this.containerNode.querySelector('[' + attrAudienceLoader + '="' + audienceType + '"]'),
					checker: checkerNode
				});
