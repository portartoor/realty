...
function crmInvoiceOpenEmailDialog(arParams)
{
	...
	BX.CrmActivityEditor.items["<?=$gridEditorID?>"].setSetting('ownerType', "<?=\CCrmOwnerType::InvoiceName?>");
	BX.CrmActivityEditor.items["<?=$gridEditorID?>"].setSetting('ownerID',<?=$arResult['ELEMENT_ID']?>);
