...
if(DealSettings::getCurrent()->getDefaultListViewID() === DealSettings::VIEW_WIDGET)
{
	$arParams['PATH_TO_DEAL_INDEX'] = $arParams['PATH_TO_DEAL_WIDGET'];
}
else
{
	...
	{
		$arParams['PATH_TO_DEAL_INDEX'] = CComponentEngine::makePathFromTemplate(
...
$arParams['PATH_TO_LEAD_INDEX'] = LeadSettings::getCurrent()->getDefaultListViewID() === LeadSettings::VIEW_WIDGET
	? $arParams['PATH_TO_LEAD_WIDGET'] : $arParams['PATH_TO_LEAD_LIST'];

$arParams['PATH_TO_INVOICE_INDEX'] = InvoiceSettings::getCurrent()->getDefaultListViewID() === InvoiceSettings::VIEW_WIDGET
	? $arParams['PATH_TO_INVOICE_WIDGET'] : $arParams['PATH_TO_INVOICE_LIST'];

$arParams['PATH_TO_COMPANY_INDEX'] = CompanySettings::getCurrent()->getDefaultListViewID() === CompanySettings::VIEW_WIDGET
	? $arParams['PATH_TO_COMPANY_WIDGET'] : $arParams['PATH_TO_COMPANY_LIST'];

$arParams['PATH_TO_CONTACT_INDEX'] = ContactSettings::getCurrent()->getDefaultListViewID() === ContactSettings::VIEW_WIDGET
	? $arParams['PATH_TO_CONTACT_WIDGET'] : $arParams['PATH_TO_CONTACT_LIST'];

$arParams['PATH_TO_ACTIVITY_INDEX'] = ActivitySettings::getCurrent()->getDefaultListViewID() === ActivitySettings::VIEW_WIDGET
	? $arParams['PATH_TO_ACTIVITY_WIDGET'] : $arParams['PATH_TO_ACTIVITY_LIST'];
