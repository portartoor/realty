...
CREATE TABLE IF NOT EXISTS b_crm_dp_index(
	...
	INDEX IX_B_CRM_DP_IND_1(USER_ID, ENTITY_TYPE_ID, ROOT_ENTITY_NAME_FLAG, ROOT_ENTITY_NAME(255), TYPE_ID),
	INDEX IX_B_CRM_DP_IND_2(USER_ID, ENTITY_TYPE_ID, ROOT_ENTITY_TITLE_FLAG, ROOT_ENTITY_TITLE(255), TYPE_ID),
	INDEX IX_B_CRM_DP_IND_3(USER_ID, ENTITY_TYPE_ID, ROOT_ENTITY_PHONE_FLAG, ROOT_ENTITY_PHONE(255), TYPE_ID),
	INDEX IX_B_CRM_DP_IND_4(USER_ID, ENTITY_TYPE_ID, ROOT_ENTITY_EMAIL_FLAG, ROOT_ENTITY_EMAIL(255), TYPE_ID),
