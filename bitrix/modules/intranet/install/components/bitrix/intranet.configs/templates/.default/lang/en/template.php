...
$MESS["CONFIG_NETWORK_AVAILABLE_TEXT"] = "You can disable your employees' communication in Bitrix24.Network by migrating to one of the commercial plans.<br/><br/>
Disabling Bitrix24.Network brings about the following changes:<br/>
<ul>
<li>Other users cannot find any of your employees in Bitrix24.Network and add them to chat.</li>
<li>Your employees cannot send messages to another Bitrix24.</li>
<li>Nobody will see recommendations from other people using Bitrix24.</li>
<li>Your contacts will not see recommendations saying your employees are using Bitrix24.</li>
</ul>
<b>To disable Bitrix24.Network and use other useful features, upgrade to \"Plus\" plan only for #PRICE#.</b>";
