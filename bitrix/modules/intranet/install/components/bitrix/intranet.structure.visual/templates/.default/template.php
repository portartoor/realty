...
?>
<span class="webform-small-button webform-small-button-blue bx24-top-toolbar-add" onclick="<?=CIntranetInviteDialog::ShowInviteDialogLink()?>">
...
?>
<span class="webform-small-button webform-small-button-blue bx24-top-toolbar-add" onclick="BX.IntranetStructure.ShowForm({IBLOCK_SECTION_ID: <?=intval($arTopEntry['ID'])?>});">
	<span class="webform-small-button-icon"></span>
...
<div class="intranet-title-buttons">
	<a class="intranet-title-button" href="javascript:void(0)" onclick="BX.IntranetStructure.ShowForm({IBLOCK_SECTION_ID: <?=intval($arTopEntry['ID'])?>});">
