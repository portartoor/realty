...
foreach($arResult as $key => $arItem):
	...
	?><span <?if (array_key_exists("ITEMS", $arItem) && count($arItem["ITEMS"]) > 0):?>data-role="bx-top-menu-item"<?endif?> class="root-item<?if ($arItem["SELECTED"]):?> selected<?endif;?>">
	<a href="<?=$arItem["LINK"]?>"><span class="left-corner"></span><span class="root-item-text"><span class="root-item-text-line"><?=$arItem["TEXT"]?></span></span><span class="right-corner"></span></a><?
