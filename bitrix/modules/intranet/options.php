...
$arSiteSettings = array('iblock_absence', 'iblock_vacancy', 'iblock_calendar', 'iblock_group_calendar',  /*'search_user_url',*/ 'path_task_group', 'path_task_group_entry', 'path_task_user', 'path_task_user_entry', 'path_user', 'BLOCK_NEW_USER_LF_SITE');
...
if($REQUEST_METHOD=="POST" && strlen($Update.$Apply.$RestoreDefaults)>0 && check_bitrix_sessid())
{
	...
	else
	{
		...
		//COption::SetOptionString("intranet", 'iblock_vacancy', $_REQUEST['IBLOCK_VACANCY'], GetMessage('INTR_OPTION_IBLOCK_VACANCY'));
		...
		COption::SetOptionString('intranet', 'mail_setup_page', $_REQUEST['mail_setup_page']);
	}
...
//$current_ib_vacancy = COption::GetOptionString('intranet', 'iblock_vacancy', '');
...
$mail_check_period = COption::GetOptionInt('intranet', 'mail_check_period', 5);
