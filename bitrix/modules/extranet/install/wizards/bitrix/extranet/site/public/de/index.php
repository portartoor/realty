...
$APPLICATION->SetTitle("Wilkommen auf der Extranet-Site");
?>
<p><table class="data-table">
<tr>
<td>
Extranet ist eine geschützte Plattform für sichere Zusammenarbeit Ihrer Mitarbeiter mit Partnern, Kunden, freien Mitarbeitern und anderen externen Benutzern.
</td>
</tr>
</table>
<p><?$APPLICATION->IncludeComponent("bitrix:desktop", ".default", array(
	...
	"G_RSSREADER_PREDEFINED_RSS" => "http://www.bitrix.de/company/news/rss/",
	"GU_RSSREADER_CNT" => "5",
	"GU_RSSREADER_RSS_URL" => "http://www.bitrix.de/company/news/rss/",
	...
	"GU_WORKGROUPS_DATE_TIME_FORMAT" => "j. F Y",
