...
if (CModule::IncludeModule('bitrix24') && $arResult["TRIAL_TEXT"])
{
					...
					<div class="tel-set-item">
						...
						<div class="tel-set-item-select-block">
							...
							<?if (!CVoxImplantAccount::IsPro() || CVoxImplantAccount::IsDemo()):?>
								<div class="tel-lock-holder-select" title="<?=GetMessage("VI_CONFIG_LOCK_ALT")?>"><div onclick="viOpenTrialPopup('vi_queue_type')" class="tel-lock tel-lock-half <?=(CVoxImplantAccount::IsDemo()? 'tel-lock-demo': '')?>"></div></div>
							<?endif;?>
							<script type="text/javascript">
								...
								BX.bind(BX('QUEUE_TYPE'), 'change', function(e){
									...
									{
										viOpenTrialPopup('vi_queue_type');
