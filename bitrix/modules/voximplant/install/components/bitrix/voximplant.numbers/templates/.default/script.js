				...
				children: [
					BX.create('td', {
						children: [
							...
							BX.create('span', {  attrs : {"style": "line-height: 20px; display: inline-block; padding: 4px 0px 8px;"}, html : BX('user_'+id).parentNode.innerHTML })
						],
						attrs: {colspan: "2"}
					})
				]
						...
						BX.create('td', {children: [
								...
								BX.create('input', {
									attrs: {
										...
										"size": "28",
										"style": "display:none" ,
										"onchange": "this.previousSibling.innerHTML = this.value",
