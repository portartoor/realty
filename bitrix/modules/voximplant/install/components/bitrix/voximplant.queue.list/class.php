...
class CVoximplantQueueListComponent extends \CBitrixComponent
{
			...
			$t_row = array(
				...
				"actions" => array(
					array(
						...
						'ONCLICK' => "jsUtils.Redirect([], '".CUtil::JSEscape($editUrl)."');",
						'DEFAULT' => true
					)
				),
			);
	...
	protected function getButtons()
	{
		$result = array(
			array(
				'TEXT' => Loc::getMessage('VOX_QUEUE_LIST_CREATE_GROUP'),
				'TITLE' => Loc::getMessage('VOX_QUEUE_LIST_CREATE_GROUP'),
				'LINK' => CVoxImplantMain::GetPublicFolder().'editgroup.php?ID=0'
			)
		);
