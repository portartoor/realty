...
if (CModule::IncludeModule('bitrix24') && (\Bitrix\Voximplant\Limits::getIvrDepth() > 0 || !\Bitrix\Voximplant\Ivr\Ivr::isEnabled()))
{
...
<script>
	...
	BX.ready(function()
	{
		BX.IvrEditor.setDefaults({
			...
			'MAX_DEPTH': <?=  0 /*\Bitrix\Voximplant\Limits::getIvrDepth()*/?>
		});
