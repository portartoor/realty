(function()
{
			...
			BX.create("div", {props: {className: 'ivr-root-lvl'}, children: [
				BX.create("div", {props: {className: 'ivr-block'}, children: [
					...
					BX.create("div", {props: {className: 'ivr-block-row'}, children: [
						BX.create("input", {props: {className: 'ivr-input-select', value: this.ivrData.NAME}, events: {
							bxchange: function(e)
							{
			...
			subElements.textInputContainer = BX.create("div", {
				...
				children: [
					...
					BX.create("div", {props: {className: 'ivr-block-row'}, children: [
						...
						BX.create("textarea", {props: {className: 'ivr-input-textarea', value: itemDescriptor.MESSAGE}, events: {
							bxchange: function(e)
							{
					...
					BX.create("div", {props: {className: 'ivr-logic-tree-section-new-btn'}, events: {
						click: function()
						{
							self.selectDigit({
								...
								onSelect: function(e)
								{
									var newAction = self.createAction(e.digit);
	...
	BX.IvrEditor.prototype._onSaveButtonClick = function()
	{
		...
		BX.ajax({
			...
			onsuccess: function(response)
			{
				...
				{
					jsUtils.Redirect([], ivrDefaults.IVR_LIST_URL);
				}
				else
				{
	...
	BX.IvrEditor.prototype.createAction = function (digit)
	{
		return {
			ID: null,
			ACTION: '',
