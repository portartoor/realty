...
)
{
	...
	else if($params["COMMAND"] == "GetNextAction")
	{
		...
		{
			$queueParams = \Bitrix\Voximplant\Model\QueueTable::getById($params['QUEUE_ID'])->fetch();
		}

		if (isset($queueParams['TYPE']) && $queueParams['TYPE'] == CVoxImplantConfig::QUEUE_TYPE_ALL)
		{
