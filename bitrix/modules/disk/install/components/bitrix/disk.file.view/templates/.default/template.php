						...
						<tr>
							...
							<td class="bx-disk-filepage-fileinfoblock">
										...
										<td>
											<div class="bx-disk-sidebar-shared-outlink-container" style="padding-bottom: 0;">
												<div class="bx-disk-sidebar-shared-outlink-switcher-container">
													<div class="bx-disk-sidebar-shared-outlink-switcher-track <?= !empty($arResult['EXTERNAL_LINK']['LINK'])? 'on' : 'off'?>">
								...
								<?php } ?>
									...
									<? if(!empty($arResult['CAN_UPDATE']) && (!$arResult['FILE']['LOCK']['IS_LOCKED'] || $arResult['FILE']['LOCK']['IS_LOCKED_BY_SELF']) && \Bitrix\Disk\TypeFile::isDocument($arResult['FILE']['NAME'])){?><a id="bx-disk-file-edit-btn" class="bx-disk-btn bx-disk-btn-big bx-disk-btn-lightgray" href=""><?= Loc::getMessage('DISK_FILE_VIEW_FILE_EDIT') ?></a><? } ?>
