										...
										children: [
											BX.create('table', {
												...
												children: [
													...
													BX.create('tr', {
														html: '<tr>' +
															'<td class="bx-disk-popup-shared-people-list-col1" style="border-bottom: none;"><a class="bx-disk-filepage-used-people-link" href=""><span class="bx-disk-filepage-used-people-avatar" style="background-image: url(' + objectOwner.avatar + ');"></span>' + BX.util.htmlspecialchars(objectOwner.name) + '</a></td>' +
														'</tr>'
													})
												]
											}),
