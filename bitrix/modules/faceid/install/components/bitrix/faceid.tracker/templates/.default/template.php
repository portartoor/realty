...
\Bitrix\Main\Page\Asset::getInstance()->addJs($this->GetFolder().'/WebPhotoMaker.js');
\Bitrix\Main\Page\Asset::getInstance()->addJs($this->GetFolder().'/smoother.js');
\Bitrix\Main\Page\Asset::getInstance()->addJs($this->GetFolder().'/fpsmeter.min.js');
...
<div class="faceid-tracker-wrapper">
	...
	<div class="faceid-tracker-sidebar">
		...
		<div class="faceid-tracker-sidebar-photo">
			...
			<video id="faceid-video">Video stream not available.</video>
            <canvas id="faceid-overlay-face-border" style="position: absolute; top: 0px; left: 0px;"></canvas>
		...
		<div class="faceid-tracker-sidebar-settings">
			<div class="faceid-tracker-sidebar-settings-title">
				<span class="faceid-tracker-sidebar-title-item"><?=Loc::getMessage('FACEID_TRACKER_CMP_AUTO')?></span>
			...
			<div class="faceid-tracker-sidebar-settings-control">
				<div class="faceid-tracker-sidebar-settings-control-item">
						<span class="faceid-tracker-sidebar-settings-control-inner">
							...
							<label for="faceid-auto-identify" class="faceid-tracker-sidebar-settings-control-label"><?=Loc::getMessage('FACEID_TRACKER_CMP_AUTO_PHOTO')?></label>
				...
				<div class="faceid-tracker-sidebar-settings-control-item">
						<span class="faceid-tracker-sidebar-settings-control-inner">
							...
							<label for="2" class="faceid-tracker-sidebar-settings-control-label" style="color: #ccc"><?=Loc::getMessage('FACEID_TRACKER_CMP_AUTO_LEAD')?></label>
							<span class="faceid-tracker-control-info"></span>
						</span>
				</div>
				...
				<div class="faceid-tracker-sidebar-status-link">
					<a href="#" class="faceid-tracker-sidebar-status-link-item"><?=Loc::getMessage('FACEID_TRACKER_CMP_STATS_DETAILED')?></a>
				</div>
...
<div class="tracker-agreement-shadow">
	<div class="tracker-agreement-popup">
		...
		<?=Loc::getMessage('FACEID_TRACKER_CMP_AGR_TEXT')?>
