...
if ($arResult['PERM_CAN_EDIT'])
{
	...
	?>
	<div class="webform-small-button webform-small-button-blue bx24-top-toolbar-add" id="crm-webform-list-create" style="cursor: pointer" title="<?=Loc::getMessage('OL_COMPONENT_LIST_ADD_LINE_DESC')?>">
