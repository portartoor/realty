...
{
	ShowError(Loc::getMessage('IMOL_MAIL_FORMAT_ERROR'));
	return;
}
?>
		...
		<td>
			<div style="background: #fff; border: 1px solid #dfe2e5; border-radius: 8px; padding: 15px;">
				<table border="0" cellpadding="0" cellspacing="0" style="margin:0; padding:0; width: 100%;" width="100%">
					<tr>
						<td bgcolor="#ffffff"  style="background: #ffffff; padding-bottom: 5px;text-align: left;" ><span style="color: #b2b2b2; font-size: 12px; line-height: 14px; font-family: Helvetica, Arial, sans-serif; word-break: break-word;"><?=Loc::getMessage('IMOL_MAIL_MESSAGE_SYSTEM')?></span></td>
...
<div style="text-align: center;padding-bottom: 40px;"><a href="<?=$arResult['TEMPLATE_WIDGET_URL']?>" style="color: #535C6A; text-decoration: underline; font-weight: 400; font-size: 13px; line-height: 15px; font-family: Helvetica, Arial, sans-serif;"><?=Loc::getMessage('IMOL_MAIL_WRITE_TO_LINE')?></a></div>
<?else:?>
<div style="text-align: center; padding-bottom: 20px;"><a href="<?=$arResult['TEMPLATE_WIDGET_URL']?>" style="color: #FFFFFF; text-decoration: none; font-weight: 400; font-size: 13px; line-height: 17px; font-family: Helvetica, Arial, sans-serif; display: inline-block; padding: 11px 24px; background-color: #3BC8F5; border-radius:2px"><?=Loc::getMessage('IMOL_MAIL_BACK_TO_TALK')?></a></div>
<?endif;?>

<div style="width: 100%;margin-bottom: 10px;"><span style="color: #A3ACB2; font-weight: 300; font-size: 11px; line-height: 15px; font-family: Helvetica, Arial, sans-serif;"><?=Loc::getMessage('IMOL_MAIL_DONT_REPLY')?></span></div>