...
class Tracker
{
	...
	public function user($params)
	{
		...
		if ($crmData)
		{
			...
			$userViewChat = \CIMContactList::InRecent($params['OPERATOR_ID'], IM_MESSAGE_CHAT, $params['SESSION_ID']);
	...
	public function sendLimitMessage($params)
	{
		...
		$userViewChat = \CIMContactList::InRecent($params['OPERATOR_ID'], IM_MESSAGE_CHAT, $chatId);
